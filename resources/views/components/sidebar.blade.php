...
@php
    $navItems = [
        ...
        ['key' => 'users',     'label' => 'Pengguna',  'icon' => 'users',  'route' => null],
        ['key' => 'reports',   'label' => 'Laporan',   'icon' => 'file-text', 'route' => null],
        ['key' => 'settings',  'label' => 'Pengaturan','icon' => 'settings',  'route' => null],
    ];
