...
<body class="d-flex flex-column min-vh-100">
    ...
    <script>
        ...
        // (mis. sticky storefront-nav atau ancestor flex/transform). Tanpa ini,
        // klik tombol close kadang tidak respons karena ter-overlay backdrop.
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Atribut tambahan opsional: data-confirm-title, data-confirm-icon,
            // data-confirm-button, data-confirm-color.
            document.body.addEventListener('submit', function (e) {
                const form = e.target;
                if (! (form instanceof HTMLFormElement)) return;
                if (! form.hasAttribute('data-confirm')) return;
                if (form.dataset.confirmed === '1') return;
                if (typeof Swal === 'undefined') return; // fallback: biarkan submit normal
